...
import { ButtonSelect, Box, Icon } from '@saviynt/design-system';
...
```js
import React, { useState } from 'react';
import { Badge, Box, ButtonSelect, Icon } from '@saviynt/design-system';
...
<Box className='selectedPillContainer'>
  <ButtonSelect
    kind='pill'
